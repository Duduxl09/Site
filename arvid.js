...
const lindbladTemporadas = {};

const lindbladCampeonato = {};

const lindbladContainer =
document.querySelector(".lindblad-corridas-container");

const lindbladSummary =
document.querySelector(".lindblad-season-summary");

const lindbladBtns =
document.querySelectorAll(".lindblad-ano-btn");

/* ==========================
TEMPORADA 2026 VIA API
========================== */

async function carregarlindblad2026(){

try{

const req =
await fetch(
"https://api.jolpi.ca/ergast/f1/2026/drivers/arvid_lindblad/results.json"
);
...
logo:
"icons/racingbulls.svg"

});

});

lindbladTemporadas["2026"] =
temporada;
...
?.find(
d=>
d.Driver.driverId==="arvid_lindblad"
);

if(lindblad){
posicaoCampeonato =
`${lindblad.position}&ordm;`;
}
...
lindbladContainer.innerHTML="";

const temporada =
lindbladTemporadas[ano] || [];
...
card.className=
`lindblad-corrida-card ${corrida.tipo}`;
...
<span class="lindblad-gp">
${corrida.gp} GP
</span>

<div class="lindblad-team">

<img
src="${corrida.logo}"
class="lindblad-team-logo">

</div>

<span class="lindblad-resultado">
${corrida.pos}
</span>

<span class="lindblad-pontos-texto">
${corrida.pontos} pts
</span>

`;

lindbladContainer.appendChild(
card
);
...
const resumo =
lindbladCampeonato[ano];

if(
lindbladSummary
){

lindbladSummary.innerHTML=`

<div
class="lindblad-summary-card show">

<h3
class="lindblad-summary-title">
...
<div
class="lindblad-summary-stats">

<div
class="lindblad-summary-box">

<span
class="lindblad-summary-label">
...
async function iniciarlindblad(){

await carregarlindblad2026();

lindbladBtns.forEach(btn=>{

btn.addEventListener(
"click",
()=>{

lindbladBtns.forEach(
b=>
b.classList.remove(
"active"
)
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    new IntersectionObserver(
      ...
      (entries, observer) => {
        ...
        entries.forEach(entry => {
          ...
          const progresso =
            card.querySelector(
              ".skill-progresso-lindblad"
            );


          const numero =
            card.querySelector(
              ".skill-numero-lindblad"
            );
  ...
  const radarSection =
    document.querySelector(
      ".pilotagem-grafico-section-lindblad"
    );
  ...
  function atualizarRadarlindblad() {
...
// =========================================
// PAINEL DE NOTÍCIAS arvid
// =========================================

const abrirNoticias = document.getElementById("abrirNoticiasarvid");
const fecharNoticias = document.getElementById("fecharNoticiasarvid");

const atualizarNoticias =
document.getElementById("atualizarNoticiasarvid");


const painelNoticias = document.getElementById("painelNoticiasarvid");
const overlayNoticias = document.getElementById("overlayNoticiasarvid");

const listaNoticias = document.getElementById("listaNoticiasarvid");
...
async function carregarNoticias(){
    ...
    listaNoticias.innerHTML = `
        <div class="loading-noticias-arvid">

            <div class="spinner-arvid"></div>
...
`https://gnews.io/api/v4/search?q="Arvid Lindblad"&lang=en&max=10&apikey=${API_KEY}`
);
        ...
        dados.articles.forEach(noticia=>{
            ...
            <div class="card-noticia-arvid">

                <img
                src="${noticia.image || 'pilotos/arvid.png'}"
                alt="Notícia">

                <div class="card-conteudo-arvid">

                    <div class="data-noticia-arvid">
...
document.getElementById("corridas-arvid");

const contadorVitorias =
document.getElementById("vitorias-arvid");

const contadorPodios =
document.getElementById("podios-arvid");

const contadorPoles =
document.getElementById("poles-arvid");

const contadorPontos =
document.getElementById("pontos-arvid");
...
console.log({
    ...
    return{
        ...
        corridas:
        historicoarvid.corridas +
        corridas2026,

        vitorias:
        historicoarvid.vitorias +
        vitorias2026,

        podios:
        historicoarvid.podios +
        podios2026,

        poles:
        historicoarvid.poles +
        poles2026,

        pontos:
historicoarvid.pontos +
pontos2026 +
pontosSprint2026
...
function animarContadores(){
    ...
    const secao =
    document.querySelector(".numeros-arvid");
    ...
    new IntersectionObserver((entradas)=>{
        ...
        entradas.forEach(entrada=>{
            ...
            if(entrada.isIntersecting){
                ...
                document
                .querySelectorAll(".contador-arvid")
                .forEach(contador=>{
...
/* =========================================================
   arvidarvid— ESTATÍSTICAS DA TEMPORADA 2026
   JOLPICA F1 API
========================================================= */
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const positionEl =
        document.getElementById("arvid-season-position");

    const pointsEl =
        document.getElementById("arvid-season-points");

    const racesEl =
        document.getElementById("arvid-season-races");

    const winsEl =
        document.getElementById("arvid-season-wins");

    const podiumsEl =
        document.getElementById("arvid-season-podiums");

    const polesEl =
        document.getElementById("arvid-season-poles");

    const top5El =
        document.getElementById("arvid-season-top5");

    const fastestLapsEl =
        document.getElementById("arvid-season-fastest-laps");

    const dnfsEl =
        document.getElementById("arvid-season-dnfs");

    const bestResultEl =
        document.getElementById("arvid-season-best-result");

    const averageFinishEl =
        document.getElementById("arvid-season-average-finish");

    const averageQualiEl =
        document.getElementById("arvid-season-average-quali");

    const bestQualiEl =
        document.getElementById("arvid-season-best-quali");

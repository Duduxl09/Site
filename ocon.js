...
async function carregarocon2026(){

try{

const req =
await fetch(
"https://api.jolpi.ca/ergast/f1/2026/drivers/ocon/results.json"
);
...
<div
class="ocon-summary-card show">

<h3
class="ocon-summary-title">
...
<div
class="ocon-summary-stats">

<div
class="ocon-summary-box">

<span
class="ocon-summary-label">
...
async function iniciarocon(){

await carregarocon2026();
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const radarSection =
    document.querySelector(
      ".pilotagem-grafico-section-ocon"
    );
...
// =========================================
// PAINEL DE NOTÍCIAS ocon
// =========================================

const abrirNoticias = document.getElementById("abrirNoticiasocon");
const fecharNoticias = document.getElementById("fecharNoticiasocon");

const atualizarNoticias =
document.getElementById("atualizarNoticiasocon");


const painelNoticias = document.getElementById("painelNoticiasocon");
const overlayNoticias = document.getElementById("overlayNoticiasocon");

const listaNoticias = document.getElementById("listaNoticiasocon");
...
async function carregarNoticias(){
    ...
    listaNoticias.innerHTML = `
        <div class="loading-noticias-ocon">

            <div class="spinner-ocon"></div>
...
`https://gnews.io/api/v4/search?q="esteban ocon"&lang=en&max=10&apikey=${API_KEY}`
);
        ...
        dados.articles.forEach(noticia=>{
            ...
            <div class="card-noticia-ocon">

                <img
                src="${noticia.image || 'pilotos/alonso.png'}"
                alt="Notícia">

                <div class="card-conteudo-ocon">

                    <div class="data-noticia-ocon">
...
document.getElementById("corridas-ocon");

const contadorVitorias =
document.getElementById("vitorias-ocon");

const contadorPodios =
document.getElementById("podios-ocon");

const contadorPoles =
document.getElementById("poles-ocon");

const contadorPontos =
document.getElementById("pontos-ocon");
...
console.log({
    ...
    return{
        ...
        corridas:
        historicoocon.corridas +
        corridas2026,

        vitorias:
        historicoocon.vitorias +
        vitorias2026,

        podios:
        historicoocon.podios +
        podios2026,
...
function animarContadores(){
    ...
    const secao =
    document.querySelector(".numeros-ocon");
    ...
    new IntersectionObserver((entradas)=>{
        ...
        entradas.forEach(entrada=>{
            ...
            if(entrada.isIntersecting){
                ...
                document
                .querySelectorAll(".contador-ocon")
                .forEach(contador=>{
...
/* =========================================================
   estebanesteban— ESTATÍSTICAS DA TEMPORADA 2026
   JOLPICA F1 API
========================================================= */
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const positionEl =
        document.getElementById("esteban-season-position");

    const pointsEl =
        document.getElementById("esteban-season-points");

    const racesEl =
        document.getElementById("esteban-season-races");

    const winsEl =
        document.getElementById("esteban-season-wins");

    const podiumsEl =
        document.getElementById("esteban-season-podiums");

    const polesEl =
        document.getElementById("esteban-season-poles");

    const top5El =
        document.getElementById("esteban-season-top5");

    const fastestLapsEl =
        document.getElementById("esteban-season-fastest-laps");

    const dnfsEl =
        document.getElementById("esteban-season-dnfs");

    const bestResultEl =
        document.getElementById("esteban-season-best-result");

    const averageFinishEl =
        document.getElementById("esteban-season-average-finish");

    const averageQualiEl =
        document.getElementById("esteban-season-average-quali");

    const bestQualiEl =
        document.getElementById("esteban-season-best-quali");
    ...
    try {
        ...
        */
        ...
        console.log(
            "🏎️ estebanesteban— TEMPORADA 2026"
        );

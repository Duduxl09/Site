...
async function carregarfranco2026(){

try{

const req =
await fetch(
"https://api.jolpi.ca/ergast/f1/2026/drivers/colapinto/results.json"
);
...
?.find(
d=>
d.Driver.driverId==="colapinto"
);

if(franco){
posicaoCampeonato =
`${franco.position}&ordm;`;
}
...
<div
class="franco-summary-card show">

<h3
class="franco-summary-title">
...
<div
class="franco-summary-stats">

<div
class="franco-summary-box">

<span
class="franco-summary-label">
...
async function iniciarfranco(){

await carregarfranco2026();
...
// =========================================
// PAINEL DE NOTÍCIAS franco
// =========================================

const abrirNoticias = document.getElementById("abrirNoticiasfranco");
const fecharNoticias = document.getElementById("fecharNoticiasfranco");

const atualizarNoticias =
document.getElementById("atualizarNoticiasfranco");


const painelNoticias = document.getElementById("painelNoticiasfranco");
const overlayNoticias = document.getElementById("overlayNoticiasfranco");

const listaNoticias = document.getElementById("listaNoticiasfranco");
...
async function carregarNoticias(){
    ...
    listaNoticias.innerHTML = `
        <div class="loading-noticias-franco">

            <div class="spinner-franco"></div>
...
`https://gnews.io/api/v4/search?q="franco colapinto"&lang=en&max=10&apikey=${API_KEY}`
);
        ...
        dados.articles.forEach(noticia=>{
            ...
            <div class="card-noticia-franco">

                <img
                src="${noticia.image || 'pilotos/franco.png'}"
                alt="Notícia">

                <div class="card-conteudo-franco">

                    <div class="data-noticia-franco">
...
document.getElementById("corridas-franco");

const contadorVitorias =
document.getElementById("vitorias-franco");

const contadorPodios =
document.getElementById("podios-franco");

const contadorPoles =
document.getElementById("poles-franco");

const contadorPontos =
document.getElementById("pontos-franco");
...
console.log({
    ...
    return{
        ...
        corridas:
        historicofranco.corridas +
        corridas2026,

        vitorias:
        historicofranco.vitorias +
        vitorias2026,

        podios:
        historicofranco.podios +
        podios2026,

        poles:
        historicofranco.poles +
        poles2026,

        pontos:
historicofranco.pontos +
pontos2026 +
pontosSprint2026
...
function animarContadores(){
    ...
    const secao =
    document.querySelector(".numeros-franco");
    ...
    new IntersectionObserver((entradas)=>{
        ...
        entradas.forEach(entrada=>{
            ...
            if(entrada.isIntersecting){
                ...
                document
                .querySelectorAll(".contador-franco")
                .forEach(contador=>{
...
function animarCards(){
    ...
    document
    .querySelectorAll(".animar-franco")
    .forEach((card,index)=>{
...
/* =========================================================
   francofranco— ESTATÍSTICAS DA TEMPORADA 2026
   JOLPICA F1 API
========================================================= */
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const positionEl =
        document.getElementById("franco-season-position");

    const pointsEl =
        document.getElementById("franco-season-points");

    const racesEl =
        document.getElementById("franco-season-races");

    const winsEl =
        document.getElementById("franco-season-wins");

    const podiumsEl =
        document.getElementById("franco-season-podiums");

    const polesEl =
        document.getElementById("franco-season-poles");

    const top5El =
        document.getElementById("franco-season-top5");

    const fastestLapsEl =
        document.getElementById("franco-season-fastest-laps");

    const dnfsEl =
        document.getElementById("franco-season-dnfs");

    const bestResultEl =
        document.getElementById("franco-season-best-result");

    const averageFinishEl =
        document.getElementById("franco-season-average-finish");

    const averageQualiEl =
        document.getElementById("franco-season-average-quali");

    const bestQualiEl =
        document.getElementById("franco-season-best-quali");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    new IntersectionObserver(
      ...
      (entries, observer) => {
        ...
        entries.forEach(entry => {
          ...
          const progresso =
            card.querySelector(
              ".skill-progresso-colapinto"
            );


          const numero =
            card.querySelector(
              ".skill-numero-colapinto"
            );
  ...
  const radarSection =
    document.querySelector(
      ".pilotagem-grafico-section-colapinto"
    );


  const radarArea =
    document.querySelector(
      ".radar-area-colapinto"
    );


  const pontosRadar =
    document.querySelectorAll(
      ".radar-ponto-colapinto"
    );
  ...
  function atualizarRadarcolapinto() {
